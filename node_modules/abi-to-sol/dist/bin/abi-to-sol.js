...
Options:
  <name>
    Name of generated interface. Default: ${src_1.defaults.name}

  --validate
    Validate JSON before starting

  -V --solidity-version
    Version of Solidity (for pragma). Default: ${src_1.defaults.solidityVersion}

  -L --license
    SPDX license identifier. Default: ${src_1.defaults.license}
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const options = {
        ...
        mode: (args["-E"] || args["--embedded"]) ? src_1.GenerateSolidityMode.Embedded : src_1.GenerateSolidityMode.Normal
    };
