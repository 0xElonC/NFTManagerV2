...
exports.AbiPropertiesCollector = exports.analyze = exports.observableProperties = void 0;
const visitor_1 = require("../visitor");
exports.observableProperties = [
    "defines-receive",
    "defines-fallback",
    "needs-abiencoder-v2",
    "defines-error",
];
const analyze = (node) => (0, visitor_1.dispatch)({
    node,
    visitor: new AbiPropertiesCollector(),
});
exports.analyze = analyze;
class AbiPropertiesCollector {
    visitAbi({ node: nodes }) {
        return nodes
...
exports.AbiPropertiesCollector = AbiPropertiesCollector;
